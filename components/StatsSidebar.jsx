  ...
  return (
    <aside className="stats-sidebar">
      <div className="stats-sidebar-section">
        <h3 className="stats-sidebar-title">Racha actual</h3>
        {currentStreak > 0 ? (
          <StreakBadge count={currentStreak} size="large" />
        ) : (
          <div className="stats-empty">Empieza a acertar 🎯</div>
        )}
      </div>

      {bestStreak > 0 && (
        <div className="stats-sidebar-section">
          <h3 className="stats-sidebar-title">Mejor racha</h3>
      ...
      {mode === "classic" && totalRounds > 0 && (
        <div className="stats-sidebar-section">
          <h3 className="stats-sidebar-title">Progreso</h3>
      ...
      {score !== undefined && mode === "classic" && (
        <div className="stats-sidebar-section">
          <h3 className="stats-sidebar-title">Puntuación</h3>
          <div className="stats-score">
            <span className="stats-score-num">{score}</span>
            <span className="stats-score-label">aciertos</span>
          </div>
        </div>
      )}
    </aside>
