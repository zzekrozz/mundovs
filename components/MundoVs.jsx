...
function Game({ countryA, countryB, steps, currentStep, phase, userPick, userScore, countryWins, stepResults, onPick, onNext, onNewGame, onReplay }) {
  ...
  // Trigger confetti and vibration on correct answer
  useEffect(() => {
  ...
  return (
    <div className="game-wrap">
      ...
      <div className="vs-hero" style={{ background: step.gradient }}>
        {step.backgrounds && step.backgrounds.length > 0 && (
          <div className="vs-hero-bg" style={{ backgroundImage: `url(${getRandomBackground(step)})` }} />
        )}
...
function Reveal({ cA, cB, step, va, vb, result, countryWins, currentStep, totalSteps, onNext }) {
  ...
  return (
    <>
      ...
      <CuriosityBox 
        text={buildViralPhrase(cA, cB, step)} 
        icon={result.correct ? "🔥" : "💡"} 
        category={step.group}
  ...
  return (
    <div className="game-wrap">
      ...
      <div className="vs-hero" style={{ background: category.gradient }}>
        {category.backgrounds && category.backgrounds.length > 0 && (
          <div className="vs-hero-bg" style={{ backgroundImage: `url(${getRandomBackground(category)})` }} />
        )}
