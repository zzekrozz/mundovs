...
function getMsg(event, hintsLeft) {
...
// ─── Google Maps URL ──────────────────────────────────────────────────────────
function getGoogleMapsUrl() { return "https://www.google.com/maps"; }
...
export default function PaisDelDia({ dayOffset = 0 }) {
  ...
  function handleGuess(country) {
    ...
    const msg     = correct ? rnd(MESSAGES.win) : getMsg("fail", MAX_HINTS - revealedHints);
      ...
      <div className="pdd-mv-loading">
        <div className="pdd-mv-loading-inner">
          <svg width="48" height="48" viewBox="0 0 48 48">
            ...
            <circle cx="24" cy="24" r="14" fill="none" stroke="#1d9e75" strokeWidth="1.2" opacity=".6" className="pdd-mv-spin-ring"/>
    ...
    <div className="pdd-mv-wrap">
      ...
      <div className="pdd-mv-geo-bg" aria-hidden="true">
        <svg width="100%" height="100%" viewBox="0 0 360 600" preserveAspectRatio="xMidYMid slice">
          ...
          <path d="M 20 160 Q 120 130 220 180 Q 300 220 350 200" fill="none"
            stroke="#1d9e75" strokeWidth=".9" opacity=".09" strokeDasharray="4 4" className="pdd-mv-route"/>
      ...
      {gameStatus === "playing" && (
        <div className="pdd-mv-answer-area" ref={answerRef}>
          <div className="pdd-mv-answer-cta">↓ Responder · +{possibleScore} puntos disponibles</div>
          ...
          <div className="pdd-mv-maps-hint">
            <span>¿Necesitas mirar el mapa? Puedes investigar, agente.</span>
