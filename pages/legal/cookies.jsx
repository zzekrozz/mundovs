...
function CookiePreferencesReset() {
  ...
  if (done) {
    return (
      <div className="cookie-reset-msg">
        ✅ Preferencia borrada. El banner de cookies aparecerá la próxima vez que visites MundoVS.
      </div>
    );
  }

  return (
    <div className="cookie-reset-block">
      {status && (
        <p className="cookie-reset-current">
          Tu elección actual:{" "}
          <strong>{status === "accepted" ? "✅ Cookies aceptadas" : "❌ Cookies rechazadas"}</strong>
        </p>
      )}
      <button className="cookie-reset-btn" onClick={handleReset}>
    ...
    <>
      ...
      <Layout>
        ...
        >
          ...
          <h2>Gestionar tu elección</h2>
          <p>
            Puedes cambiar tu decisión sobre las cookies en cualquier momento. Al pulsar el botón, se borrará tu preferencia guardada y el banner de cookies volverá a aparecer en la siguiente visita.
          </p>
