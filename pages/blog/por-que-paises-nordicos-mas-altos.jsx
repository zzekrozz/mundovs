...
export default function Post() {
  return (
    <BlogPost
      ...
      description="Países Bajos, Dinamarca y Noruega lideran los rankings de altura media. La explicación combina genética, nutrición infantil y siglos de bienestar social."
      date="2026-03-29"
      readTime={5}
    >
<p>
          ...
          <ul>
            <li><strong>Países Bajos:</strong> 183,8 cm</li>
            <li><strong>Dinamarca:</strong> 181,4 cm</li>
            <li><strong>Bélgica:</strong> 181,7 cm</li>
            <li><strong>Suecia:</strong> 181,5 cm</li>
            <li><strong>Noruega:</strong> 179,7 cm</li>
            <li><strong>Finlandia:</strong> 180,7 cm</li>
            <li><strong>Alemania:</strong> 180,0 cm</li>
            <li><strong>Austria:</strong> 179,0 cm</li>
            <li><strong>República Checa:</strong> 180,1 cm</li>
            <li><strong>Estonia:</strong> 181,6 cm</li>
          </ul>
          <p>
          ...
          <h2>El mito de la genética nórdica</h2>
          <p>
          ...
          <h2>Los tres factores clave</h2>

          <h3>1. Nutrición durante el crecimiento</h3>
          <p>
          ...
          <h3>2. Salud pública e infecciones infantiles</h3>
          <p>
          ...
          <h3>3. Estabilidad social y económica</h3>
          <p>
          ...
          <h2>El estancamiento de los países ricos</h2>
          <p>
          ...
          <div className="cta-box">
            <h3>Compara la altura entre países</h3>
            <p>Descubre las diferencias en cinco rondas de comparación.</p>
          ...
          <p style={{ marginTop: "2rem", padding: "1rem", background: "var(--mv-card)", borderRadius: 8, fontSize: 13, color: "var(--mv-text-dim)" }}>
            <strong>Fuentes:</strong> NCD Risk Factor Collaboration (publicado en eLife), Banco Mundial, OMS, archivos históricos de Mariposa Group.
          </p>
    </BlogPost>
  );
}
