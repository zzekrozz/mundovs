...
export default function Post() {
  return (
    <>
      <Head>
        <title>Cómo se mide el PIB per cápita y por qué a veces engaña | MundoVs</title>
        <meta name="description" content="Explicación didáctica de qué es el PIB per cápita, cómo se calcula y por qué tiene limitaciones que hay que conocer al comparar países." />
      </Head>
      <Layout>
        <ContentPage
          title="Cómo se mide el PIB per cápita y por qué a veces engaña"
          subtitle="Es el indicador más usado para comparar países, pero tiene limitaciones importantes que conviene entender."
