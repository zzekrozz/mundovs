...
export default function Post() {
  return (
    <>
      <Head>
        <title>El país que más café consume del mundo no es el que crees | MundoVs</title>
        <meta name="description" content="Brasil produce el 35% del café mundial, pero los líderes en consumo per cápita son los países nórdicos. Descubre quién se lleva la corona y por qué." />
      </Head>
      <Layout>
        <ContentPage
          title="El país que más café consume del mundo no es el que crees"
          subtitle="Brasil produce el 35% del café mundial, pero en consumo per cápita está lejísimos del podio."
        ...
        >
          ...
          <ol>
            <li><strong>Finlandia:</strong> 12,0 kg</li>
            <li><strong>Noruega:</strong> 7,2 kg</li>
            <li><strong>Dinamarca:</strong> 8,7 kg</li>
            <li><strong>Suecia:</strong> 8,2 kg</li>
            <li><strong>Países Bajos:</strong> 8,3 kg</li>
            <li><strong>Suiza:</strong> 7,9 kg</li>
            <li><strong>Bélgica:</strong> 4,8 kg</li>
            <li><strong>Italia:</strong> 5,9 kg</li>
            <li><strong>Brasil:</strong> 5,8 kg (mayor productor del mundo)</li>
            <li><strong>España:</strong> 4,5 kg</li>
          </ol>
          <p>
            Sí, has leído bien: <strong>Finlandia consume más del doble de café per cápita que Brasil</strong>, pese a que Brasil produce más de un tercio del café mundial.
          </p>

          <h2>Por qué los nórdicos beben tanto café</h2>
          <p>
            La fascinación nórdica con el café tiene varias explicaciones combinadas que merecen ser exploradas:
          </p>

          <h3>El factor climático</h3>
          <p>
            Aunque suene a tópico, el frío y los inviernos largos sí tienen algo que ver. En Finlandia, durante los meses de invierno hay regiones donde apenas amanece. El café no es solo bebida: es ritual social, calidez, momento de pausa. Los finlandeses incluso tienen una palabra específica, <em>kahvitauko</em>, que significa "pausa para el café" y está protegida por convenios laborales: muchas empresas obligan por convenio a dos pausas pagadas al día para tomar café.
          </p>

          <h3>El factor histórico</h3>
          <p>
          ...
          <h3>El factor cultural</h3>
          <p>
            En Finlandia y Suecia existe el concepto de <em>fika</em> (en sueco) o <em>kahvitauko</em> (en finés): la pausa para café acompañado de algo dulce, generalmente con compañeros de trabajo, amigos o familia. Es un ritual social tan arraigado que prácticamente nadie se lo salta. El café no se toma "a la pasada" mientras haces otra cosa: te sientas, paras y compartes.
          </p>

          <h2>El extraño caso de Italia</h2>
          <p>
          ...
          <h2>España: tradición moderada</h2>
          <p>
          ...
          <h2>Latinoamérica: paradoja productora</h2>
          <p>
          ...
          <ul>
            <li>Brasil: 5,8 kg</li>
            <li>Colombia: 2,2 kg</li>
            <li>Costa Rica: 1,0 kg</li>
            <li>Guatemala: 0,7 kg</li>
            <li>Perú: 0,4 kg</li>
            <li>Bolivia: 0,2 kg</li>
          </ul>
          <p>
          ...
          <h2>Asia: territorio del té con creciente curiosidad cafetera</h2>
          <p>
            China e India, los gigantes asiáticos, tienen consumos de café per cápita ridículamente bajos: 0,1 kg al año. Para hacernos una idea, eso es aproximadamente <strong>una taza de café cada dos meses</strong>. La cultura del té es tan dominante que el café apenas existe.
          </p>
          <p>
          ...
          <h2>Lo que nos dice este dato</h2>
          <p>
          ...
          <div className="cta-box">
            <h3>Compara hábitos de consumo entre países</h3>
            <p>Café, alcohol, McDonald's y otros datos sorprendentes en cinco rondas.</p>
            <a href="/">Jugar ahora →</a>
          </div>

          <p style={{ marginTop: "2rem", padding: "1rem", background: "#F4F2EC", borderRadius: 8, fontSize: 13, color: "#666" }}>
            <strong>Fuentes:</strong> International Coffee Organization, FAO, World Bank.
          </p>
        </ContentPage>
      </Layout>
    </>
