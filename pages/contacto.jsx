    ...
    <>
      ...
      <Layout>
        ...
        >
          ...
          <p style={{ fontSize: 18, padding: "1rem", background: "#F4F2EC", borderRadius: 8, textAlign: "center", margin: "1rem 0" }}>
          ...
          <p style={{ marginTop: "2rem", padding: "1rem", background: "#E1F5EE", borderRadius: 8, fontSize: 14 }}>
